...
public class Guitarra {
    ...
    // Criação do contruto da classe Guitarra
    public Guitarra(
    ...
    //o método mains() é metodo principal da classe
    public static  void  main(String[] args) {
        //instanciamos um objeto chamado "minhaguitarra" que será do tipo "Guitarra"
        // Os Valores passados são usados pelo contrutor da classe para criar
        //o objeto
        Guitarra minhaGuitarra = new Guitarra("01020204", "fender", "telecaster",
                "eletrica", "mogno", 1500);
